...
cooperation will fixate, as shown in figures \ref{fig:varyiter} (with
$b=5, \om=0.1,$ and $I$ ranging over $10,20,50,100,200,500$, excluding
values greater than $I^2$). This is expected, as a larger number of
interactions per round means that the opinion matrix more closely
reflects the current strategy distribution, and thus a player's
reputation is a better indicator of their current strategy.

\begin{figure}[h!tbp]
  \begin{subfigure}{.48\linewidth}
    \centering
    \includegraphics[width=\linewidth]{pop10iter.png}
    \caption{$N=10$ and $I \in \{10,20,50\}$.}
  \end{subfigure}
  \hspace{.02\linewidth}
  \begin{subfigure}{.48\linewidth}  
    \centering
    \includegraphics[width=\linewidth]{pop20iter.png}
    \caption{$N=20$ and $I \in \{10,20,50,100,200\}$.}
  \end{subfigure}

  \begin{subfigure}{.48\linewidth}
    \centering
    \includegraphics[width=\linewidth]{pop50iter.png}
    \caption{$N=50$ and $I \in \{10,20,50,100,200,500\}$.}
  \end{subfigure}
  \hspace{.02\linewidth}
  \begin{subfigure}{.48\linewidth}
    \centering
    \includegraphics[width=\linewidth]{pop100iter.png}
    \caption{$N=100$ and $I \in \{10,20,50,100,200,500\}$.}
  \end{subfigure}
  \label{fig:varyiter}
  \caption{Histograms of proporton of cooperation after 25000 rounds}
\end{figure}
