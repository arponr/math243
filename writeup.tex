...
Using this model, we show that indirect reciprocity can emerge with a much lower benetif/cost ratio than previously shown. %TODO based on experimental results
